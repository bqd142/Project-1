...
?>
    ...
    <div style="background-color: aliceblue;" class="pb-3"> <!--bánh trung thu--> 
        <h3 class="text-center mt-5 pt-4 text-danger"><?= $lang_data["homepage-danhmuc1"] ?></h3>
        ...
        <div class="row">
            <div class="col-6" >
                ...
                <img src="Media/kmpizza.jpg" alt="abc" class="float-start" style="width: 40%; padding-right: 20px;">
                    <div> 
                        <a href="#" style="text-decoration: none;" class="text-dark"><h4><?= $lang_data["homepage-km1"] ?></h4></a>
                        <p class="text-danger"><i class="fa-regular fa-calendar-days"></i> 5/7/2024 &nbsp; <i class="fa-regular fa-eye"></i> 142 </p>
                        <P style="margin-top: -12px;" class="fs-4"><?= $lang_data["homepage-km2"] ?></P> 
                    </div>
            </div>
            <div  class="col-6" >
                ...
                <img src="Media/khaitruong1.jpg" alt="abc" class="float-start" style="width:25%; padding-right: 10px;">
                    <div> 
                        <a href="#" style="text-decoration: none;" class="text-muted"><h5><?= $lang_data["homepage-cuahangmoi1"] ?></h5></a>
                        <p class="text-danger"><i class="fa-regular fa-calendar-days"></i> 5/7/2024 &nbsp; <i class="fa-regular fa-eye"></i> 142 </p>
                        <P style="margin-top: -12px;"><?= $lang_data["homepage-cuahangmoi2"] ?></P> 
                    </div>
