...
<form method="post" action="../Control/dangnhap.php">
      <div  style="width: 400px; margin-top: 100px; margin-bottom: 100px;" class="border p-3 mx-auto">
        ...
        <div class="text-center mt-3">
          <input type="submit" class="btn btn-primary" style="width: 100% ;" value="Sign in" name="txtlog">
        </div>
        <div class="mt-3 small d-flex justify-content-center">
          <p class=" d-inline">Do not have an account? </p> <a class="text-decoration-none" href="dangky.php"> Sign Up</a>
        </div>
      </div>
</form>
